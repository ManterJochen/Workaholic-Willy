...
# For a rate over the same scenes, the gates in scripts/examples/cli/08_sim/sim_pick_rate.sh.
#
...
python -m src.willy_sim.run_sorting_demo \
    --concat logs/demo/eih_pick_demo.mp4,logs/demo/bin_clearing_demo.mp4 \
    --out logs/demo/all.mp4
