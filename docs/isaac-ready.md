...
`scripts/examples/07_sim.py` checks that first and refuses with the fix.
...
in the [willy_sim README](../src/willy_sim/README.md), and `scripts/examples/07_sim.py` fronts the
first three.
