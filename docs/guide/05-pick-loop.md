...
| `python -m src.robot.execution.real_cell`, the operator console, and [`scripts/examples/api/01_first_cell/one_pick_end_to_end.py`](../../scripts/examples/api/01_first_cell/one_pick_end_to_end.py) | `from_robot_config`, through `Cell` and those two builders | the terminal, the browser and a Python script drive one construction |
...
[`scripts/examples/api/01_first_cell/one_pick_end_to_end.py`](../../scripts/examples/api/01_first_cell/one_pick_end_to_end.py).
...
[`scripts/examples/api/08_sim/sim_pick_rate.py`](../../scripts/examples/api/08_sim/sim_pick_rate.py) fronts the first runners and checks
