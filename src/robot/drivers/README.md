...
cuRobo `willy_{model}.yml` together, through `sim/robot_models.py`; the cell's hand is added to
that planner as a body link when it starts. A disagreeing `WILLY_CUROBO_ROBOT`
