...
`scripts/examples/sim/70_sim_pick.py` fronts the first three and checks the interpreter before anything
...
- `scripts/examples/sim/70_sim_pick.py`, the readiness check and a fronted run
